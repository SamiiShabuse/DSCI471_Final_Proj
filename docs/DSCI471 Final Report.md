...
![Figure 1: Top article types after preprocessing](reports/figures/eda_article_distribution.png)

**Figure 2 - Master category distribution:**

![Figure 2: Master category distribution](reports/figures/eda_master_category_distribution.png)

**Figure 3 - Color distribution:**

![Figure 3: Most common product colors](reports/figures/eda_color_distribution.png)
...
![Figure 4: Representative image grid](reports/figures/eda_sample_images_grid.png)
...
![Figure 5: Product text length distribution](reports/figures/eda_text_length_distribution.png)
...
![Figure 6: Ablation progression](reports/figures/ablation_progression.png)

**Figure 7 - v4 training loss and v4/v5 comparison:**

![Figure 7a: v4 training loss curve](reports/figures/v4_training_loss.png)

![Figure 7b: v4 vs v5 recall by query style](reports/figures/v4_vs_v5_per_style.png)
...
![Figure 8: TF-IDF vs dual-encoder test metrics](reports/figures/test_metrics_comparison.png)

**Figure 9 - Shopper-query comparison:**

![Figure 9: Shopper query metrics](reports/figures/shopper_metrics_comparison.png)
...
![Figure 10: Successful templated query retrieval](reports/figures/demo_success_templated.png)

**Figure 11 - Brand-query head-to-head:**

![Figure 11: TF-IDF vs dual-encoder brand query](reports/figures/demo_head_to_head_brand.png)

**Figure 12 - Shopper-query failure case:**

![Figure 12: Shopper query failure case](reports/figures/demo_failure_shopper.png)
...
- Final report PDF: `docs/DSCI471 Final Report.pdf`
