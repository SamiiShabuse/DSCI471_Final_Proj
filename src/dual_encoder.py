...
def make_image_dataset(image_paths, batch_size: int = 64, training: bool = False):
...
def make_training_dataset(image_paths, text_embeddings, batch_size: int = 64, training: bool = False):
...
def encode_images(model: FrozenTextDualEncoder, image_paths, batch_size: int = 64) -> np.ndarray:
...
def encode_texts(text_encoder, captions, batch_size: int = 256) -> np.ndarray:
